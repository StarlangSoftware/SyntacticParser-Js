...
class ContextFreeGrammar {
    ...
    ruleLeftComparator = (ruleA, ruleB) => (ruleA.getLeftHandSide().getName().localeCompare(ruleB.getLeftHandSide().getName()));
    ruleRightComparator = (ruleA, ruleB) => (this.ruleRightCompare(ruleA, ruleB));
    ruleComparator = (ruleA, ruleB) => (ruleA.getLeftHandSide().getName() != ruleB.getLeftHandSide().getName() ? this.ruleLeftComparator(ruleA, ruleB) : this.ruleRightComparator(ruleA, ruleB));
